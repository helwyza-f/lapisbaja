...
export default function Navbar() {
  ...
  // Helper untuk menentukan status active link
    ...
    <header className="sticky top-0 z-50 w-full border-b border-slate-100 bg-white/95 backdrop-blur-md">
      <div className="container mx-auto px-4 md:px-6 h-20 md:h-24 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 md:gap-6">
          ...
          <Button
            size="lg"
            className="bg-primary hover:bg-orange-600 text-white font-black uppercase text-[10px] md:text-xs tracking-widest rounded-full px-5 md:px-8 h-10 md:h-12 shadow-lg shadow-orange-500/10 transition-all active:scale-95"
            asChild
          >
          ...
          {/* Mobile Menu Toggle */}
          <button
            className="lg:hidden w-10 h-10 flex items-center justify-center text-slate-900 bg-slate-50 rounded-full border border-slate-100 transition-transform active:scale-90"
      ...
      >
        <nav className="p-6 space-y-1">
          ...
          <div className="pt-6 pb-2 grid grid-cols-2 gap-4 px-4">
            <Button
              variant="outline"
              className="rounded-full font-black uppercase tracking-widest text-[9px] border-slate-200 h-11"
              asChild
            >
            ...
            <Button
              className="rounded-full font-black uppercase tracking-widest text-[9px] bg-slate-900 h-11 shadow-md shadow-slate-900/10"
              asChild
            >
